...
export const translations = {
  en: {
    ...
    // API Reference (AI)
    "api.subtitle": "Public Endpoints",
    "api.title": "API Reference",
    "api.description": "All endpoints require authentication via X-API-Key header.",
    "api.search.title": "Search",
    "api.search.method": "POST /v1/search",
    "api.search.desc": "Unified vector search across companies and investors.",
    "api.search.curl": "curl -X POST https://api.northern-lights.app/v1/search \\\n  -H 'X-API-Key: YOUR_API_KEY' \\\n  -H 'Content-Type: application/json' \\\n  -d '{\"query\": \"tech\"}'",
    "api.companies.title": "Companies",
    "api.companies.method": "GET /v1/companies/{org_id}",
    "api.companies.desc": "Get detailed company information with ownership and sector data.",
    "api.companies.curl": "curl -X GET 'https://api.northern-lights.app/v1/companies/5591234567' \\\n  -H 'X-API-Key: YOUR_API_KEY'",
    "api.investors.title": "Investors",
    "api.investors.method": "GET /v1/investors/{investor_id}",
    "api.investors.desc": "Retrieve investor profile and portfolio holdings.",
    "api.investors.curl": "curl -X GET 'https://api.northern-lights.app/v1/investors/inv_12345' \\\n  -H 'X-API-Key: YOUR_API_KEY'",
    "api.network.title": "Network Graph",
    "api.network.method": "GET /v1/relationships/network/{entity_id}",
    "api.network.desc": "Get ownership relationships and corporate network graph.",
    "api.network.curl": "curl -X GET 'https://api.northern-lights.app/v1/relationships/network/entity_12345' \\\n  -H 'X-API-Key: YOUR_API_KEY'",
    "api.health.title": "Health Check",
    "api.health.method": "GET /api/health",
    "api.health.desc": "Service status and availability endpoint.",
    "api.health.curl": "curl -X GET 'https://api.northern-lights.app/api/health'",
    "api.copy": "Copy",
    "api.copied": "Copied!",
  ...
  sv: {
    ...
    // API Reference (AI)
    "api.subtitle": "Publika Slutpunkter",
    "api.title": "API Referens",
    "api.description": "Alla slutpunkter kräver autentisering via X-API-Key-rubrik.",
    "api.search.title": "Sök",
    "api.search.method": "POST /v1/search",
    "api.search.desc": "Enhetlig vektorsökning över företag och investerare.",
    "api.search.curl": "curl -X POST https://api.northern-lights.app/v1/search \\\n  -H 'X-API-Key: YOUR_API_KEY' \\\n  -H 'Content-Type: application/json' \\\n  -d '{\"query\": \"tech\"}'",
    "api.companies.title": "Företag",
    "api.companies.method": "GET /v1/companies/{org_id}",
    "api.companies.desc": "Hämta detaljerad företagsinformation med ägar- och sektordata.",
    "api.companies.curl": "curl -X GET 'https://api.northern-lights.app/v1/companies/5591234567' \\\n  -H 'X-API-Key: YOUR_API_KEY'",
    "api.investors.title": "Investerare",
    "api.investors.method": "GET /v1/investors/{investor_id}",
    "api.investors.desc": "Hämta investerarprofil och portföljinnehav.",
    "api.investors.curl": "curl -X GET 'https://api.northern-lights.app/v1/investors/inv_12345' \\\n  -H 'X-API-Key: YOUR_API_KEY'",
    "api.network.title": "Nätverksgraf",
    "api.network.method": "GET /v1/relationships/network/{entity_id}",
    "api.network.desc": "Hämta ägarrelationer och företagsnätverksgraf.",
    "api.network.curl": "curl -X GET 'https://api.northern-lights.app/v1/relationships/network/entity_12345' \\\n  -H 'X-API-Key: YOUR_API_KEY'",
    "api.health.title": "Hälsokontroll",
    "api.health.method": "GET /api/health",
    "api.health.desc": "Slutpunkt för tjänststatus och tillgänglighet.",
    "api.health.curl": "curl -X GET 'https://api.northern-lights.app/api/health'",
    "api.copy": "Kopiera",
    "api.copied": "Kopierad!",
